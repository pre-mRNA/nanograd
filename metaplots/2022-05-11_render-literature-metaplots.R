...
# gadi 
# sdepth_out <- "/g/data/lf10/as7425/nanograd/analysis/literature_metaplots/metaplot_input/2022-11-05_samtools-depth.txt.gz"
...
# gadi: 
# human_annotation <- "/g/data/lf10/as7425/nanograd/analysis/literature_metaplots/metaplot_input/GRCh38.104.metadata.txt"
...
# gadi 
# merged_metadata <- read_tsv("/g/data/lf10/as7425/nanograd/analysis/literature_metaplots/metaplot_input/GRCh38.104.metadata.txt", col_names = T, col_types = "ffffnnnn")
