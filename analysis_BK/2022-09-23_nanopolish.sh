...
runNano() {
  ...
  nanopolish eventalign --reads ${fastq} --bam ${alignment} --genome ${genome} -v -t 48 --scale-events --print-read-names --samples > ${outputDir} || echo "$(date)....nanopolish alignment failed"
...
export outputDir="/g/data/xc17/bk9031/2022_nanograd_bk/analysis/2021_HEK293-degradation-first4-AR/nanopoilish"
